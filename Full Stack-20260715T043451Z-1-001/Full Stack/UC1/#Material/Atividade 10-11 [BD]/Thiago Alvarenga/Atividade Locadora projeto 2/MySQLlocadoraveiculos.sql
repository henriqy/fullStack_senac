...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Nov-2023 às 16:11
...
CREATE DATABASE IF NOT EXISTS `locadoraveiculos` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
(1, '69097124', 'r.itabu', 26, 'manaus'),
(2, '69097123', 'r.itabuaba', 16, 'manaus'),
(3, '69097125', 'r.itabuna', 28, 'manaus');
...
INSERT INTO `aluga` (`cod_cnh`, `cod_placa`, `dt`) VALUES
('00000000000', 'ANK04051', '2023-10-12'),
('11111111111', 'JKL1216', '2023-10-12'),
('22222222222', 'JKM1216', '2023-10-12');
...
INSERT INTO `carro` (`placa`, `cod_agen`, `modelo`, `ano`) VALUES
('ANK04051', 1, 'GOL', 2012),
('JKL1216', 2, 'CIVIC', 2010),
('JKM1216', 3, 'POLO', 2023);
...
('00000000000', 'Ricardo', '0000111122223333'),
('11111111111', 'Thiago', '1111222233334444'),
('22222222222', 'Brenda', '0000111122223333');
...
INSERT INTO `cliente_telefone` (`cod_cliente`, `numero`) VALUES
('00000000000', '92995213775'),
('11111111111', '92995213774'),
('22222222222', '92995213773');
...
--
ALTER TABLE `carro`
  ADD CONSTRAINT `carro_ibfk_1` FOREIGN KEY (`cod_agen`) REFERENCES `agencia` (`numag`);

--
-- Limitadores para a tabela `cliente_telefone`
--
ALTER TABLE `cliente_telefone`
  ADD CONSTRAINT `cliente_telefone_ibfk_1` FOREIGN KEY (`cod_cliente`) REFERENCES `cliente` (`cnh`);
--
...
('root', '2023-11-10 15:10:19', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
