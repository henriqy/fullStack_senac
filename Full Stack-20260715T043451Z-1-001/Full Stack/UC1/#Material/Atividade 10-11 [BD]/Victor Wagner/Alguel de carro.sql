...
--
-- Banco de dados: `agencia_aluguel`
--
DROP DATABASE IF EXISTS `agencia_aluguel`;
CREATE DATABASE IF NOT EXISTS `agencia_aluguel` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `agencia_aluguel`;
...
('12345678989', 'Pedro', '123456789123456'),
('45645645612', 'Mordecai', '654321987321654'),
('98765432121', 'Madalena', '987654321654321');
...
('root', '2023-11-10 15:40:16', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
