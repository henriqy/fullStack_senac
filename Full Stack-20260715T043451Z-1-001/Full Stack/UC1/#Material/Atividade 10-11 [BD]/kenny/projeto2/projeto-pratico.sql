...
('root', '2023-11-10 15:50:58', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Banco de dados: `projeto_pratico`
--
DROP DATABASE IF EXISTS `projeto_pratico`;
CREATE DATABASE IF NOT EXISTS `projeto_pratico` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `projeto_pratico`;
...
CREATE TABLE `agencia` (
  ...
  `end_rua` varchar(15) DEFAULT NULL,
  `end_cep` varchar(11) DEFAULT NULL,
...
INSERT INTO `cliente` (`cnh`, `cartao`, `nome`) VALUES
(15263974, '152648957157', 'joao'),
(76212354, '879686869964', 'Maria'),
(2147483647, '2676542390072', 'marcos');
