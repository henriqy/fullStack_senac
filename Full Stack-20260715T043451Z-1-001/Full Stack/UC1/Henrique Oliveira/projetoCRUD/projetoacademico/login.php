...
<body>
    ...
    <main class="conteudo">
        <section class="container">
            ...
            <!--verificar se a variavel de sessao "nao_autenticada" existe(ISSET)-->
            <?php
            ...
            <div class="notification is-danger" align='center'>
                <p style="color:red"><strong>ERRO: Usario ou senha invalidos</strong></p>

            </div>
            
            <!--fechar o if e apagar a variavel de sessao "nao_autenticado"-->
            <?php
                endif; //fechando o if
                
                unset($_SESSION['nao_autenticado']);//apagando variavel-unset
